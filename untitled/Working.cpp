    ...
    QObject::connect(timer, &QTimer::timeout,[&](){
        ...
        for(int i=0;i<4;i++){
            ...
            if ((this->data.getelevator(i).getplace() == 0 || this->data.getelevator(i).getplace() == 20)) {
             ...
             this->data.getelevator(i).press(5);
...
//                        this->data.press(i,this->data.getpeopleup(this->data.getelevator(i).getplace()).front().getdestination(),);
                        this->data.getelevator(i).pushpeopleStay(this->data.getpeopleup(this->data.getelevator(i).getplace()).front());//这一层的人进了 电梯 但是还没有确定去 哪个目的地
...
//                        this->data.press(i,this->data.getpeopledown(this->data.getelevator(i).getplace()).front().getdestination(),this->data.getpeopledown(this->data.getelevator(i).getplace()).front()); //i代表几号电梯  ii代表想去哪个楼层
                        this->data.getelevator(i).pushpeopleStay(this->data.getpeopledown(this->data.getelevator(i).getplace()).front());//这一层的人进了 电梯 但是还没有确定去 哪个目的地
